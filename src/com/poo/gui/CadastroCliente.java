...
import com.poo.gui.tm.ClienteTableModel;
import com.poo.to.Cliente;
...
public class CadastroCliente extends javax.swing.JInternalFrame {
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (validarFormulario()) {
            ...
            cliente.setCpf(ftfCpf.getText().trim());
    ...
    private boolean validarFormulario() {
        ...
        if (ftfCpf.getText().trim().length() != 14) {
            JOptionPane.showMessageDialog(this, "CPF invalido.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfCpf.requestFocus();
            return false;
        }
        if (((Date) ftfDataNascimento.getValue()).after(new Date())) {
            JOptionPane.showMessageDialog(this, "Data de nascimento invalida.", "Alerta", JOptionPane.WARNING_MESSAGE);
