...
import com.poo.gui.tm.ProdutoTableModel;
import com.poo.to.Produto;
...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/novo.png"))); // NOI18N
        btNovo.setText("Novo");
        btNovo.setFocusable(false);
        btNovo.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btNovo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btNovo.setMargin(new java.awt.Insets(2, 8, 2, 8));
        btNovo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/novo-foco.png"))); // NOI18N
        ...
        btSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/salvar.png"))); // NOI18N
        ...
        btSalvar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/salvar-foco.png"))); // NOI18N
        ...
        btExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/excluir.png"))); // NOI18N
        ...
        btExcluir.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/excluir-foco.png"))); // NOI18N
        ...
        btCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/cancelar.png"))); // NOI18N
        ...
        btCancelar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/poo/gui/img/cancelar-foco.png"))); // NOI18N
        ...
        pnForm.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), javax.swing.BorderFactory.createTitledBorder(null, "Formulario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(102, 153, 255)))); // NOI18N
        ...
        lbPrecoCompra.setText("Preco de compra:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        ftfPrecoCompra.setValue(new Object());
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        ftfPrecoVenda.setValue(new Object());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
    ...
    private boolean validarFormulario() {
        ...
        if (((Double) ftfPrecoCompra.getValue()) <= 0) {
            JOptionPane.showMessageDialog(this, "Preco de compra invalido.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoCompra.requestFocus();
            return false;
        }
        if (((Double) ftfPrecoVenda.getValue()) <= 0) {
            JOptionPane.showMessageDialog(this, "Preco de venda invalido.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoVenda.requestFocus();
            return false;
        }
        if (((Double) ftfPrecoVenda.getValue()) <= ((Double) ftfPrecoCompra.getValue())) {
            JOptionPane.showMessageDialog(this, "Preco de venda menor que preco de compra.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoVenda.requestFocus();
            return false;
        }
        return true;
